...
public class FormularioVendas extends javax.swing.JFrame {
     ...
     public FormularioVendas(Funcionario func) {
       
        initComponents();
        this.func = func;
        System.out.println("Funcionario recebido " + func.getNome());
    }
  ...
  /*  public FormularioVendas(Funcionario f) {
...
//       r.getModel().setSelectedItem(f);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        cliente = dao.BuscarClienteNome(nome);
    ...
    private void btnPagamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPagamentoActionPerformed
        ...
        FormularioPagamento tela = new FormularioPagamento();
        tela.nomeCliente =  txtNome.getText();
        String nome = txtNome.getName();
        String cpf = txtCpf.getText();
        
        System.out.println("enviando " + tela.nomeVendedor);
        ...
        if (obj.getNome() != null && obj.getCpf() != null) {
            ...
            System.out.println("enviado para telapag" + telaPag.nomeVendedor);
